...
export default function Contact() {
  const openingHours = [
    { day: "Mardi - Vendredi", morning: "09h-12h", afternoon: "13h-17h", status: "Ouvert", isSpecial: false },
    { day: "Samedi - Lundi", morning: "", afternoon: "", status: "Fermé", isSpecial: true, color: "text-red-600" },
  ];
