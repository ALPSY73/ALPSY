            ...
            >
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-light-blue rounded-lg flex items-center justify-center mr-4">
                  <service.icon className="text-primary-blue-dark text-xl h-6 w-6" />
                </div>
              ...
              <div className="text-gray-500 text-sm flex items-center" data-testid={`service-duration-${index}`}>
                <Clock className="h-4 w-4 mr-1 text-primary-blue-dark" />
                {service.duration}
              </div>
              <div className="text-primary-blue-dark font-bold" data-testid={`service-price-${index}`}>
                {service.price}
              </div>
            </div>
          ))}
